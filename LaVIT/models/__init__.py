"""LaVIT model construction for TIGeR."""
...
def build_model(
    ...
    if not local_files_only:
        print("Downloading the LaVIT checkpoint from Hugging Face")
    ...
    if understanding:
        ...
        lavit = LaVITforGeneration(model_path=model_path, model_dtype=model_dtype, device_id=device_id, 
                ...
                load_llama=load_llama, load_quantizer=load_quantizer, load_pixel_decoder=load_pixel_decoder)
