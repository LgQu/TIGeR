...
class LaVITforUnderstanding(nn.Module):
    ...
    @torch.no_grad()
    def get_img_txt_embeds(
        self,
        samples,
        add_special_tokens=False
    ):
        """Create joint image/text embeddings for the supplied samples."""
        ...
        if prompt != "":
            ...
            prompt_tokens = self.llama_tokenizer(
                prompt, padding="longest", return_tensors="pt", add_special_tokens=add_special_tokens
            ).to(image.device)
    ...
    def generate(
        ...
        **kwargs
        ...
        # Suppressed token logits are set to negative infinity during generation.
        ...
        # print(outputs)
        # print(self.llama_tokenizer.batch_decode(outputs, skip_special_tokens=False))
